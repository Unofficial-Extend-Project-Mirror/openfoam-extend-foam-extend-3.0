...
template<class Type>
blockConvectionScheme<Type>::blockConvectionScheme(const blockConvectionScheme& cs)
:
    refCount(),
    mesh_(cs.mesh_)
{}
...
template<class Type>
tmp<blockConvectionScheme<Type> > blockConvectionScheme<Type>::New
(
    const fvMesh& mesh,
...
)
{
    if (fv::debug)
    {
        Info<< "blockConvectionScheme<Type>::New"
               "(const fvMesh&, const surfaceScalarField&, Istream&) : "
               "constructing blockConvectionScheme<Type>"
            << endl;
    }
    ...
    if (schemeData.eof())
    {
        FatalIOErrorIn
        (
            "blockConvectionScheme<Type>::New"
            "(const fvMesh&, const surfaceScalarField&, Istream&)",
            schemeData
...
template<class Type>
blockConvectionScheme<Type>::~blockConvectionScheme()
{}
...
template<class Type>
void blockConvectionScheme<Type>::operator=(const blockConvectionScheme<Type>& cs)
{
    if (this == &cs)
    {
        FatalErrorIn
        (
            "blockConvectionScheme<Type>::operator=(const blockConvectionScheme<Type>&)"
