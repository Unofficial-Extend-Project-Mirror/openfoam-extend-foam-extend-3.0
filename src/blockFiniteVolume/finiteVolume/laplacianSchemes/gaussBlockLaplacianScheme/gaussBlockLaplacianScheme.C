...
gaussBlockLaplacianScheme<Type, GType>::fvmLaplacianUncorrected
(
...
gaussBlockLaplacianScheme<Type, GType>::gammaSnGradCorr
(
...
template<class Type, class GType>
tmp<blockFvMatrix<Type> >
gaussBlockLaplacianScheme<Type, GType>::fvmLaplacian
(
...
)
{
    ...
    tmp<blockFvMatrix<Type> > tfvm = fvmLaplacianUncorrected(SfGammaSn, vf);
    blockFvMatrix<Type>& fvm = tfvm();
