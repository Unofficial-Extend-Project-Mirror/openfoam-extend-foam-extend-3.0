...
#define doMakeVectorNMatrixInterfaceFunc(type, Type, args...)                 \
    VectorNMatrixInterfaceFunc(type)

#define MacroArgs doMakeVectorNMatrixInterfaceFunc
#include "forAllVectorNTypes.H"

#undef doMakeVectorNMatrixInterfaceFunc

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

// Instantiate for all VectorN, TensorN, etc. types
